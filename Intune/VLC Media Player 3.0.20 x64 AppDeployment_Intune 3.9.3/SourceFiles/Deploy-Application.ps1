...
Try {
    ...
    [String]$appScriptDate = '13/10/2023'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-MSI -Path "$dirFiles\vlc-3.0.20-win64.msi" -Parameters '/qn /norestart /ACCEPT_EULA=true'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-MSI -Path "$dirFiles\vlc-3.0.20-win64.msi" -Parameters '/uninstall /norestart /quiet'
