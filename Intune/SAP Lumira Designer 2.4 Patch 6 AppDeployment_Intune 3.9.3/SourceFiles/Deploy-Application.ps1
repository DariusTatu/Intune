...
Try {
    ...
    [String]$appName = 'Lumira Designer 2.4'
    [String]$appVersion = '2.4 Patch 6'
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '16/05/2023'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        ## Installation SAP Lumira Designer
        
        Execute-process -path "LU_Designer00P_6-80004773.EXE" -parameters "/silent /noDLG" -IgnoreExitCodes '129'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-Process -Path "$envProgramFilesX86\SAP\SAPsetup\setup\NwSapSetup.exe" -Parameters "/Uninstall /Product='LAADx64' /silent /NoDlg /IgnoreMissingProducts /norestart"
        ...
        Remove-Folder -Path "$envProgramFiles\SAP Lumira"
