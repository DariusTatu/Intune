...
##Try {
    ...
    [String]$appName = 'Visual C++ 2013'
    [String]$appVersion = '12.0.40660'
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '13/09/2023'
    ...
    ##If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') 
        ...
        Execute-Process -Path "$dirFiles\vcredist_x64.exe" -Parameters '/q /NORESTART'
