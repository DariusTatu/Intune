...
##Try {
    ...
    [String]$appVersion = '12.0.35.218 '
    [String]$appArch = 'x86'
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '25/10/2023'
    ...
    ##If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') 
        ...
        ## Installation Think-Cell 35218 
        
        Execute-Process -Path "$dirFiles\setup_think-cell_35218.exe" -parameters '/qn'
        ...
        Set-RegistryKey -Key "Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Classes\SOFTWARE\think-cell" -Name "licensekey" -Value "D2QZ3-TCB6U-U4A78-KPLYM-SLCKE" -Type "String"
...

    {
        ...
        ## Uninstall Think-Cell 35218

        Execute-MSI -action "uninstall" -path "{2A7E6C17-8903-4AEE-84BB-47320CCD7A8E}" -Parameters '/qn'
