...
Try {
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        $netFx3Capability = Get-WindowsCapability -Online | Where-Object { $_.Name -like '*NetFX3*' }

        if ($netFx3Capability -and $netFx3Capability.State -ne 'Installed') {
        Add-WindowsCapability -Online -Name $netFx3Capability.Name
        }
        ...
        Execute-Process -Path "$dirFiles\VSCodeSetup-x64-1.81.1.exe" -Parameters '/VERYSILENT /NORESTART /MERGETASKS=!runcode'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-Process -Path "C:\Program Files\Microsoft VS Code\unins000.exe" -Parameters '/SILENT'
