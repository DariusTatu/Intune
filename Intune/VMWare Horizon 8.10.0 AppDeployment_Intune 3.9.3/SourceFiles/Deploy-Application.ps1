...
Try {
    ...
    [String]$appName = 'VMWare Horrizon'
    [String]$appVersion = '8.10.0'
    [String]$appArch = 'x64'
    [String]$appLang = 'MUI'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '16/08/2023'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Execute-Process -Path "$dirFiles\VMware-Horizon-Client-2306-8.10.0-21964678.exe" -Parameters '/silent /install /norestart DESKTOP_SHORTCUT=0 AUTO_UPDATE_ENABLED=0'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
		...
		Execute-Process -Path "$dirFiles\VMware-Horizon-Client-2306-8.10.0-21964678.exe" -parameters "/uninstall /quiet /norestart"
