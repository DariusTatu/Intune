...
Try {
    ...
    [String]$appVendor = 'Twingate'
    [String]$appName = 'Twingate'
    [String]$appVersion = '1.0.30.22347'
    [String]$appArch = 'x64'
    [String]$appLang = 'MUI'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-MSI -Path "$dirFiles\TwingateWindowsInstaller.msi" -Parameters '/norestart /quiet'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-MSI -Path "$dirFiles\TwingateWindowsInstaller.msi" -Parameters '/uninstall /norestart /quiet'
