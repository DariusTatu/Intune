...
Try {
    ...
    [String]$appName = 'Visual Studio 2010 Tools for Office Runtime'
    [String]$appVersion = '10.0.60910'
    [String]$appArch = 'x64'
    [String]$appLang = 'MUI'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '27/10/2023'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        ## Installation Micorosoft Visual Studio 2010 Tools for Office Runtime 10.0.60910

        Execute-Process -Path "$dirFiles\vstor_redist.exe" -Parameters '/q /norestart'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        ## Uninstall Micorosoft Visual Studio 2010 Tools for Office Runtime 10.0.60910

        Execute-Process -Path "$dirFiles\vstor_redist.exe" -Parameters '/uninstall /q /norestart'
