...
##Try {
    ...
    [String]$appScriptDate = '13/06/2023'
    ...
    ##If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') 
        ...
        Execute-Process -Path "$dirFiles\WinSCP-6.1-Setup.exe" -Parameters '/SP- /VERYSILENT /SUPPRESMSGBOXES /ALLUSERS /DESKTOP_SHORTCUT=0'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') 
        ...
        Execute-Process -Path "$dirFiles\WinSCP-6.1-Setup.exe" -Parameters '/SP- /VERYSILENT /SUPPRESMSGBOXES /ALLUSERS'
